...
* The file IMGTGENE-DB-ReferenceSequences.fasta-AA-WithoutGaps-F+ORF+inframeP includes IMGT/GENE-DB amino reference sequences for functional, 
  open reading frame and in-frame pseudogene genes and alleles, without IMGT gaps.
...
An IMGT/GENE-DB reference sequence for a given IG or TR gene is provided, in the 5’ > 3’ DNA strand orientation corresponding to the  'sense', ‘plus’ or ‘coding strand’
of that gene (DNA strand orientation, http://www.imgt.org/IMGTindex/dnaStrand.php). 
The orientation (direct or opposite) of an IG or TR gene in a given IMGT locus is given in Locus Gene order (Genomic orientation, http://www.imgt.org/IMGTindex/genomicOrientation.php )
IMGT Repertoire (IG and TR) > 1. Locus and genes > 3. Locus descriptions > Locus gene order (http://www.imgt.org/IMGTrepertoire/LocusGenes/#C)
...
IMGT/GENE-DB program and data upgrades are available from the top of the query page.
