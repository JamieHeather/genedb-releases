This directory contains IMGT/GENE-DB reference sequences in FASTA format.


* The file GENE-DB-ReferenceSequences.fasta-nt-WithGaps-F+ORF+inframeP includes IMGT/GENE-DB nucleotide reference sequences for functional, 
  open reading frame and in-frame pseudogene genes and alleles, with IMGT gaps for V and C genes and alleles.

* The file GENE-DB-ReferenceSequences.fasta-nt-WithoutGaps-F+ORF+inframeP includes IMGT/GENE-DB nucleotide reference sequences for functional, 
  open reading frame and in-frame pseudogene genes and alleles, without IMGT gaps.

* The file GENE-DB-ReferenceSequences.fasta-nt-WithoutGaps-F+ORF+allP includes IMGT/GENE-DB nucleotide reference sequences for functional, 
  open reading frame and all pseudogene genes and alleles, without IMGT gaps.

* The file GENE-DB-ReferenceSequences.fasta-AA-WithGaps-F+ORF+inframeP includes IMGT/GENE-DB amino acid reference sequences for functional, 
  open reading frame and in-frame pseudogene genes and alleles, with IMGT gaps for V and C genes and alleles.

* The file GENE-DB-ReferenceSequences.fasta-AA-WithoutGaps-F+ORF+inframeP includes IMGT/GENE-DB amino reference sequences for functional, 
  open reading frame and in-frame pseudogene genes and alleles, without IMGT gaps.
...
and for each allele, the allele functionality, and the IMGT reference sequences and other sequences from the literature. 
...
IMGT/GENE-DB program and data upgrades are available from http://www.imgt.org/IMGT_GENE-DB/share/textes/help.html#upgrade.

Statistics are available from the IMGT/GENE-DB home page.
